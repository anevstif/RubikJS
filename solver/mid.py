...
def findMidEdge(cube:cube_t, edge:int):
	...
	dir = {	0:[	
		...
		["D' "+fm[1][0],	fm[2][1]]],
			1:[
		[fm[2][1]+" D "+ fm[1][1],	fm[1][0]+" D2 "+fm[1][1]],
		["",						fm[1][1]+" D2 "+fm[1][1]],
		...
		["D' "+fm[1][1],	"D2 "+fm[3][0]]],
			2:[
		[fm[2][1]+" D' "+fm[0][0],	fm[1][0]+" "+fm[0][0]],
		[fm[3][0]+" D "+fm[0][0],	fm[1][1]+" "+fm[0][0]],
		["",						""+fm[0][0]],
		[""+fm[0][0],	fm[0][0]+" D2 "+fm[0][0]],
		["",""],["",""],["",""],["",""],
		["",""],
		["",""],
		["",""],
...
def solvMid(cube:cube_t):
	edges = [0,1]
	solv = ""
	for e in edges:
		solv = solv.strip() + " " + findMidEdge(cube, e).strip()
	return solv.strip()
